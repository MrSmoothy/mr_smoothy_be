...
-- ให้แก้เป็น "http://minio.thanonchai.site/fruit/banana.png"
UPDATE fruits 
SET image_url = CASE 
    ...
    THEN CONCAT('http://minio.thanonchai.site/', image_url, '.png')
    ...
    THEN CONCAT('http://minio.thanonchai.site/fruit/', image_url, '.png')
    ...
    THEN CONCAT('http://minio.thanonchai.site/', 
